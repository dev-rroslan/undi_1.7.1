defmodule UndiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(UndiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(UndiWeb.Gettext, "errors", msg, opts)
    end
  end
